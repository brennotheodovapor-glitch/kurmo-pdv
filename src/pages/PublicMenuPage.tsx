<button onClick={()=>window.open('https://wa.me/?text='+encodeURIComponent('Confira nosso cardapio online: https://kurmo-pdv.vercel.app/menu'),'_blank')} style={{position:'fixed',bottom:80,right:16,width:44,height:44,borderRadius:'50%',background:'#25d366',border:'none',display:'flex',alignItems:'center',justifyContent:'center',cursor:'pointer',zIndex:40,boxShadow:'0 2px 12px rgba(37,211,102,0.4)'}}>
